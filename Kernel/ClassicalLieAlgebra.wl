...
RepresentationDimension::usage = "RepresentationDimension[Irrep[g, w]] gives the dimension of the irrep (Weyl dimension formula).";
CasimirEigenvalue::usage = "CasimirEigenvalue[Irrep[g, w]] gives the eigenvalue of the quadratic Casimir on the irrep, normalized so that long roots have squared length 2. (Mathematicians' normalization: e.g. the su(2) spin-1/2 value is 3/2, twice the physics value 3/4.)";
...
TableauNormalization::zeronorm = "Cannot normalize a zero-norm TensorTableau expression.";
TableauOrthogonalization::zeronorm = "Cannot orthogonalize against a zero-norm first TensorTableau expression.";
